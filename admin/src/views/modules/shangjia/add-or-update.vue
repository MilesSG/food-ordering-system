  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.zizhi" label="资质" prop="zizhi">
          <file-upload
          tip="点击上传资质"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zizhi" label="资质" prop="zizhi">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zizhi.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <!-- <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.xingbie"
                placeholder="性别" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="审核" prop="shenhe">
          <el-input v-model="ruleForm.shenhe" 
              placeholder="审核" clearable  :readonly="ro.shenhe"></el-input>
              <!-- <el-select v-model="value" class="m-2" placeholder="Select">
            <el-option
               v-for="item in shenheOptions"
              :key="item.value"
               :label="item.label"
               :value="item.value"
                />
        ...
        <div v-else>
          <el-form-item class="input" label="审核" prop="shenhe">
              <el-input v-model="ruleForm.shenhe" 
...
<script>
// 数字，邮件，手机，url，身份证校验
import { isNumber,isIntNumer,isEmail,isPhone,isURL,checkIdCard } from "@/utils/validate";
export default {
  data() {
    let self = this
