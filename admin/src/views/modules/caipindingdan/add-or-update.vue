  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="菜品价格" prop="caipinjiage">
              <el-input v-model="ruleForm.caipinjiage" 
                placeholder="菜品价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="下单数量" prop="xiadanshuliang">
          <el-input v-model="ruleForm.xiadanshuliang" 
              placeholder="下单数量" clearable  :readonly="ro.xiadanshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="下单数量" prop="xiadanshuliang">
              <el-input v-model="ruleForm.xiadanshuliang" 
                placeholder="下单数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.xiadanshijian" label="下单时间" prop="xiadanshijian">
              <el-input v-model="ruleForm.xiadanshijian" 
                placeholder="下单时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="餐桌号" prop="canzhuohao">
          <el-select v-model="ruleForm.canzhuohao" placeholder="请选择餐桌号">
            <el-option
                v-for="(item,index) in canzhuohaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="餐桌号" prop="canzhuohao">
	      <el-input v-model="ruleForm.canzhuohao"
                placeholder="餐桌号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                    zongjine:{
                                                                                                                                                                                                                                get: function () {
        return 1*this.ruleForm.caipinjiage*this.ruleForm.xiadanshuliang
      }
    },
                                                                                                  },
  created() {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.caipinjiage = true;
            continue;
	            	            ...
	            	            if(o=='xiadanshuliang'){
            this.ruleForm.xiadanshuliang = obj[o];
	    this.ro.xiadanshuliang = true;
            continue;
          }
	            	            if(o=='zongjine'){
	    ...
	    this.ro.xiadanshijian = true;
            continue;
	            	            ...
	            	            if(o=='canzhuohao'){
            this.ruleForm.canzhuohao = obj[o];
	    this.ro.canzhuohao = true;
            continue;
          }
	            	            if(o=='yonghuming'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                                                          ...
                                                                                                                                                                                          this.$http({
              url: `option/canzhuo/canzhuohao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.canzhuohaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
