<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="餐桌号" prop="canzhuohao">
          <el-input v-model="ruleForm.canzhuohao" 
              placeholder="餐桌号" clearable  :readonly="ro.canzhuohao"></el-input>
        </el-form-item>
        <div v-else>
            ...
            ruleForm: {
                	        canzhuohao: '',
	                        	        ...
	                        	        zuoweishu: '',
                                                      ...
                                                      rules: {
                  canzhuohao: [
                            { required: true, message: '餐桌号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  weizhi: [
                                    	                                                              ],
                  zuoweishu: [
